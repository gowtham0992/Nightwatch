...
from nightwatch.datasets import assert_no_eval_leakage, load_curriculum, load_eval_cases, load_predictions
...
def run_gate_fixture(args: argparse.Namespace) -> int:
    ...
    report = {"baseline": baseline.to_dict(), "candidate": candidate.to_dict(), "gate": result.to_dict()}
...
def build_parser() -> argparse.ArgumentParser:
    ...
    fixture.add_argument("--eval", type=Path, default=Path("data/eval/frozen.jsonl"))
