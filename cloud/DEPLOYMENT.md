...
The canonical public judge URL is `https://nightwatch-public-w3a6oefsma-uc.a.run.app`. The current public, authenticated, and public-proof releases are `nightwatch-public-agentproof2`, `nightwatch-evidence-agentproof2`, and `nightwatch-public-verifier-agentproof2`, all from immutable service image digest `sha256:5adde6d84784213dacc736371b885cabb848b8902e4359b4c802a733805f9a12`. The private stage worker is `nightwatch-mission-worker-agentproof2` on mission image digest `sha256:550536b27c8d9d1af153217446d552065535c8be7b57e00fd16bdf69421479c0`. The judge view defaults to the fresh agent-proof refusal mission and exposes only its bundled, strictly redacted evidence.
