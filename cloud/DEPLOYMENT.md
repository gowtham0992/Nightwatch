...
The canonical public judge URL is `https://nightwatch-public-w3a6oefsma-uc.a.run.app`. Release `mission-switcher-v1` runs revision `nightwatch-public-00004-jr4` from immutable image digest `sha256:31aef9568fae7d76ff9af8e32f2907e5dd4893b32aba8715e4714ee14f8d28c3`. Its default mission is the unattended refusal `nightwatch-cloud-20260811-001`; public receipt `verify-e4ddbd80cb6f876654508fa779d4df2384de2f2c` verifies Firestore head `b75997fa00e6263d1e5139d1047ea04eef02ab25c4f0f12188cadf7ed1154a85`. The judge UI preloads that artifact and the retained qualification `nightwatch-v2-qualification`, then exposes both through a URL-addressable verified mission archive.
