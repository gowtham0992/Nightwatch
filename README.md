...
<p align="center">
  ...
  · <a href="https://youtu.be/6CvGwsMZ_I8">Demo video</a>
...
**Submission pack:** [Hosted project](https://nightwatch-public-w3a6oefsma-uc.a.run.app/) · [3:55 demo](https://youtu.be/6CvGwsMZ_I8) · [Source code](https://github.com/gowtham0992/Nightwatch) · [Judge quickstart](#judge-quickstart) · [Architecture](docs/architecture.md) · [Google Cloud proof](cloud/DEPLOYMENT.md)<br>
**Bonus:** Gemma 3 is the pinned student model repaired and evaluated by Nightwatch · [Public X launch post](https://x.com/GothamSarves/status/2094237249235992972) with `#AllThingsAgenticHackathon`

## Watch Nightwatch run the complete repair mission

<p align="center">
  <a href="https://www.youtube.com/watch?v=6CvGwsMZ_I8">
    <img src="https://img.youtube.com/vi/6CvGwsMZ_I8/maxresdefault.jpg" alt="Watch Nightwatch run an autonomous model-repair mission with deterministic release gates" width="720">
  </a>
</p>

<p align="center">
  <a href="https://www.youtube.com/watch?v=6CvGwsMZ_I8"><strong>Watch the 3:55 final demo</strong></a> · Continuous mission execution · Governed agents · Google Cloud proof · Deterministic release decision
</p>
...
| **Demo video** | The public [3:55 final demo](https://youtu.be/6CvGwsMZ_I8) shows a continuous autonomous mission from sealed contract to refusal, the governed follow-up boundary, qualified and hidden-regression counterexamples, and visible Google Cloud deployment and evidence proof. |
